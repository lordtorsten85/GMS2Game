...
// Description: Initializes global manager for pause state, health, ammo, and inventory systems
...
global.equipment_slots = instance_create_layer(0, 0, "GUI", obj_equipment_slots, 
    {
        ...
        grid_height: 1,
        slot_size: 64,
        inv_gui_x: display_get_gui_width() - 128 - 400, // Adjusted to -128 - 400 as per your tweak
        inv_gui_y: display_get_gui_height() - 64 - 24, // Bottom-aligned, 64px slot height + 24px top padding
        dragging: -1,
        drag_offset_x: 0,
        drag_offset_y: 0,
        original_grid: -1,
