...
// Description: Initializes an item instance when dropped, preserving mod inventory data.
// Variable Definitions:
// - item_id: real (set via instance_create_layer)
// - stack_quantity: real (set via instance_create_layer)
// - contained_items: array (set via instance_create_layer)
// - placement_id: real (set via instance_create_layer)
// - is_in_world: boolean (set via instance_create_layer)
...
if (item_id != ITEM.NONE && array_length(global.item_data) > item_id) {
