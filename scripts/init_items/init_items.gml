// Script: init_items
// Description: Defines and initializes all item data and global structures for the game, called at game startup.
...
function initialize_item_data() {
    ...
    global.item_data[ITEM.SMALL_GUN] = ["Small Gun", 2, 1, false, c_blue, spr_gun_laser, ITEM_TYPE.WEAPON, 1, true, 2, 2];
    ...
    global.item_data[ITEM.OPTICS] = ["Optics", 1, 2, false, c_green, spr_utility_test, ITEM_TYPE.UTILITY, 1, true, 1, 2];

    // Initialize global mod inventories map
